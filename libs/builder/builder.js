...
(function(){
  ...
  */
  ...
  Vvveb.Builder = {
      ...
      init: function(content, type, callback) {
  ...
  /* controls */    	
      ...
      loadUrl : function(url, callback) {	
          ...
          self.initCallback = callback;
          if (!Vvveb.Builder.iframe) return;
          if (Vvveb.Builder.iframe.srcdoc) Vvveb.Builder.iframe.removeAttribute("srcdoc");
          if (Vvveb.Builder.iframe.src != url) Vvveb.Builder.iframe.src = url;
      },
      
  /* iframe */
      _loadIframe : function(content, type) {	
  
          var self = this;
          self.iframe = this.documentFrame.get(0);
          if(type === "url"){
              self.iframe.src = content;
          }else{
              self.iframe.srcdoc = content;
          }
  ...
  Vvveb.Sections = {
      ...
      loadSections: function(extSections) {
          var sections = extSections? extSections: this.getSections();
